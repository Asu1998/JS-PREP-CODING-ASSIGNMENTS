...
// Input Format
// The first line of input contains the first string  S 1 . The second line of input contains the second string  S 2 .

// Output Format
// Return "YES" if  S 1  is a substring of  S 2   else return "NO".

// Constraints
// 1 ≤ | S 1 | , | S 2 | ≤ 100 , where  | S |  denotes the length of string  S . 
